...
public final class AssetTransfer implements ContractInterface {
     ...
     * @param newAssetId the new ID of the duplicated asset
    ...
    public Asset DuplicateAsset(final Context ctx, final String assetID, final String newAssetId, final String newOwner) {
        ...
        return CreateAsset(ctx, newAssetId, oldAsset.getColor(), oldAsset.getSize(), newOwner, oldAsset.getAppraisedValue());
    }
}
